class DataExportService {
  ...
  getAllData() {
    try {
      ...
      const data = {
        ...
        accounts: financialService.getAccounts(),
  ...
  importDataToServices(data) {
    ...
    try {
      ...
      if (data.transactions || data.accounts || data.budgets || data.financialGoals || data.bills) {
        if (data.transactions) {
          localStorage.setItem('financialTransactions', JSON.stringify(data.transactions));
        ...
        if (data.budgets) {
          localStorage.setItem('financialBudgets', JSON.stringify(data.budgets));
        ...
        if (data.bills) {
          localStorage.setItem('financialBills', JSON.stringify(data.bills));
