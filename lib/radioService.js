...
class RadioService {
  ...
  async getRomanianStations() {
    // Return comprehensive list of Romanian stations with HTTPS prioritized URLs
    const romanianStations = [
      ...
      },
      {
        ...
        urls: [
          ...
          'https://stream2.srr.ro:8016/RomanaMuzical.mp3',
      ...
      },
      {
        ...
        urls: [
          ...
          'https://stream2.srr.ro:8024/Actualitati.mp3',
      ...
      },
      {
        ...
        urls: [
          ...
          'https://stream2.srr.ro:8012/Cultural.mp3',
      ...
      },
      {
        ...
        urls: [
          ...
          'http://live.europafm.ro/EuropaFM.mp3'
        ],
        country: 'Romania',
        language: 'Romanian',
        genre: 'News, Talk',
      ...
      },
      {
        ...
        urls: [
          ...
          'http://live.virginradio.ro/virgin.mp3'
        ],
        country: 'Romania',
        language: 'Romanian',
        genre: 'Top 40,Pop',
      ...
      },
      {
        ...
        urls: [
          ...
          'https://www.radiotanana.ro:8000/radiotanana.mp3',
      ...
      },
      {
        ...
        urls: [
          ...
          'https://www.radioimpact.ro:8000/impact.mp3',
      ...
      },
      {
        ...
        urls: [
          ...
          'https://www.guerrillaradio.ro:8000/guerrilla.mp3',
    ...
    // Prioritize HTTPS URLs for better compatibility with live deployments
    return romanianStations.map(station => ({
      ...station,
      url: station.urls[0], // Primary URL (HTTPS prioritized)
  ...
  async getInternationalStations() {
    ...
    const internationalStations = [
      ...
      },
      {
        id: 'rtl-france',
        name: 'RTL France',
        url: 'https://stream.rtl.fr/rtl-1-44-128',
        country: 'France',
        language: 'French',
        genre: 'News,Talk',
      ...
      },
      {
        id: 'rfm-france',
        name: 'RFM France',
        url: 'https://scdn.nrjaudio.fm/fr/30301/mp3_128.mp3',
        country: 'France',
        language: 'French',
        genre: 'Pop,Top 40',
      ...
      },
      {
        id: 'nyc-public-radio',
        name: 'WNYC New York',
        url: 'https://fm-stream.wnyc.org/wnycfm',
        country: 'USA',
        language: 'English',
        genre: 'News,Talk',
      ...
      },
      {
        id: 'jazz24',
        name: 'Jazz 24',
        url: 'https://live.amperwave.net/direct/kuow-jazz24mp3-96',
        country: 'USA',
        language: 'English',
        genre: 'Jazz',
      ...
      },
      {
        ...
        url: 'https://media-ssl.musicradio.com/AbsoluteRadio',
        country: 'United Kingdom',
        language: 'English',
        genre: 'Rock,Pop',
