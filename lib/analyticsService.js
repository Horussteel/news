...
class AnalyticsService {
  ...
  calculateOverallProductivity() {
    ...
    const habitScore = (overview.totalActive > 0 ? overview.totalActive / overview.totalHabits * 100 : 0) * weights.habits;
    const readingScore = overview.readingCompletionRate * weights.reading;
    
    return Math.round((todoScore + habitScore + readingScore) * 100);
  }
